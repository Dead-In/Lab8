...
### Вывод: я научился устанавливать компоненты, необходимые для android разработки, настроила Qt для работы с android и научилась создавать приложения для android при помощи Qt.
